...
// 2. Mengambil Berita Reguler / Utama
try {
    $query = "
...
// 3. Mengambil Top 5 Berita Terpopuler (Untuk Sidebar Kanan)
try {
...
// 4. Logika Highlight (Hanya tampil jika di Beranda Utama tanpa filter)
$highlight_utama = null;
$highlight_samping = [];

if (count($semua_berita) > 0 && empty($filter_kategori)) {
...
<style>
    ...
    /* Item Berita Populer di Sidebar */
...
<div class="home-container">
    ...
    <div class="kategori-nav">
        <a href="/" class="kategori-pill <?= empty($filter_kategori) ? 'active' : '' ?>">Highlight Utama</a>
    ...
    <div class="content-wrapper">
        ...
        <main class="main-content">
            <h3 class="section-title">
                ...
                <?= empty($filter_kategori) ? 'Berita Terkini Lainnya' : 'Berita: ' . htmlspecialchars(ucfirst(str_replace('-', ' ', $filter_kategori))) ?>
            </h3>
            ...
            <div class="news-grid">
                ...
                <?php else: ?>
                    <div style="grid-column: 1 / -1; text-align: center; padding: 40px 20px; color: #64748b;">
                        ...
                        <p>Belum ada berita lainnya untuk ditampilkan.</p>
                    </div>
                <?php endif; ?>
            </div>
        </main>
